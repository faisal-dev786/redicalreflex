        ...
        <>
            <div className="bg-[#13191F]">
                <div className="wrapper">
                    <h1 className="text-center py-5 sm:py-10 font-bold text-white text-2xl sm:text-4xl">OUR FLAGSHIP PROJECTS</h1>
                    <p className="text-[#7f8992] text-center pb-5 sm:pb-10 ">PROVIDING RADICAL WEB & BRANDING SOLUTIONS ACROSS THE GLOBE SINCE 1999</p>
                </div>
