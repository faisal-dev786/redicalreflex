        ...
        <>
            <div className='bg-[#13191F]'>
                <div className='px-10 sm:px-32'>
                    ...
                    <div className="grid">
                        <div className='p-5 sm:p-10 rounded-tl-lg rounded-tr-lg sm:rounded-tr
                        ...
                        sm:border-x sm:border-y sm:border-solid sm:border-[#94A9B1]'>
                            ...
                            text-1xl sm:text-2xl font-light mb-5'>LOGO DESIGNING</h1>
                            <p className='text-[#94A9B1] mb-5 text-center sm:text-left'>We, at RadicalReflex, specialize in custom and corporate logo design for business. Hire professionals from the best logo design company in India to build a unique brand presence for your business.</p>
                        </div>
                       ...
                       sm:border-l-0 sm:border-r sm:border-y sm:border-solid sm:border-[#94A9B1]'>
                            ...
                            <p className='text-[#94A9B1] text-center sm:text-left mb-5'>Your brand is a perception and we help perception of people align with your brand aspirations. Our process of digital branding helps you close the gap between what people think of you today and what you want them to think of you in future.</p>
                        </div>
                        ...
                        border-x border-y border-solid border-[#94A9B1] 
                         sm:border-y sm:border-r sm:border-l-0 sm:border-solid sm:border-[#94A9B1] sm:rounded-tr-lg '>
                            ...
                            <p className='text-[#94A9B1] text-center sm:text-left mb-5'>Being the best web designing company in Delhi NCR. We have a team of qualified, experienced and passionate professionals who create fresh design for your website. It will give an extra edge to your business opening up plenty of new opportunities.</p>
                        </div>
                        ...
                        sm:border-l-0 '>
                            ...
                            <p className='text-[#94A9B1] text-center sm:text-left mb-5'>We create the company profile considering your business nature, products, your imagination, ideas, your marketplace, targeted customers and your vision. Combining these elements, we prepare the profile design keeping in mind your needs and expectations.</p>
                        </div>
