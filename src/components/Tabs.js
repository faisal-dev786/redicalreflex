...
export default function Tabs() {
  ...
  return (<>
    ...
    <div className="">
      <div className="wrapper w-full max-w-md  px-2 py-16 sm:px-0">
        <Tab.Group>
            ...
            <Tab.Panel>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-10'>
                ...
                {logos.map((item,index) => {
                  return <div key={index} className="my-10 w-[400px] border border-solid border-[#868d94] rounded-lg ">
                    <a href=""> <img className=" h-[230px] w-[400px] p-3 object-cover " src={item.img} alt="" /></a>
